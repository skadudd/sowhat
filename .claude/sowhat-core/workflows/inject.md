...
> **AI Content Boundary**: inject는 사용자 제공 자료를 섹션에 주입한다. AI는 원본 내용 추출·요약만 수행 — 원본에 없는 수치·기관명 보간 금지. 추출된 구체값에는 `[source:file:{path}]` 또는 `[source:user]` 태그가 자동 부착된다. 상세: `references/ai-content-boundary.md`.
