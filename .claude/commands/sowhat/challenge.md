...
description: 논증 트리를 8단계(Stage 0 사실검증 + Stage 1-7 논리검증)로 공격한다. Stage 0은 Grounds의 수치·사실·사례를 1차 출처 대조로 검증하고, Stage 1-7은 Walton + Pragma-Dialectics 논리 검증을 수행한다. 섹션 지정 시 해당 섹션만 부분 검증, 미지정 시 전체 트리 검증. "전체 검증", "논리 점검", "challenge", "논증 공격", "최종 검토", "품질 검사", "팩트체크" 등 settled 전이나 finalize 전 최종 검증 시 사용하라.
