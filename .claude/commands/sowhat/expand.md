...
❓ 이 섹션은 thesis의 어떤 Key Argument를 지지합니까?
  ...
  Thesis Answer: "{00-thesis.md의 Answer}"

  Key Arguments:
  [1] {key argument 1}
  [2] {key argument 2}
  [3] {key argument 3}
  (00-thesis.md에 있는 Key Arguments 전부 나열)
  [N+1] 직접 입력 (새 논거)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
인간 선택 → `scheme` 필드에 저장. 이 scheme이 이후 모든 질문의 맥락을 결정한다.

---

### 스텝 3: Claim 핑퐁

섹션 제목, thesis Answer, thesis_argument, scheme을 함께 고려하여 Claim에 대한 구체적 제안 3개를 생성한다.

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❓ 이 섹션의 핵심 주장(Claim)은 무엇입니까?
   ({scheme} 방식 논증 / "{thesis_argument}" 지지)

──── 예시 ────
  너무 넓음: "시장이 중요하다"  → Claim이 아니라 토픽
  적절함: "국내 SaaS 시장은 연 30% 성장 중이며 진입 시점은 지금이다"

──── 제안 ────
  [1] {이 논증 맥락에 맞는 구체적 Claim 제안 1}
  [2] {구체적 Claim 제안 2}
  [3] {구체적 Claim 제안 3}
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❓ 이 인과관계의 근거(Grounds)는 무엇입니까?
   (cause-effect 논증: 메커니즘과 인과 증거)

──── 예시 ────
  "사용자 인터뷰 30건: 80%가 전환 비용을 이탈 이유로 꼽음"
  "A/B 테스트: 기능 X 제거 시 이탈률 40% 증가"

──── 제안 ────
  [1] {이 논증 맥락에 맞는 구체적 근거 제안 1}
  [2] {구체적 근거 제안 2}
  [3] {구체적 근거 제안 3}

──── 기타 ────
  [4] 직접 작성
  [5] 리서치 먼저 (/sowhat:research 실행)
  [6] 잘 모르겠다 → Open Question 등록
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❓ 이 주장의 근거(Grounds)가 되는 권위자/전문가 의견은?
   (authority 논증: 전문가 신뢰도와 출처)

──── 예시 ────
  "Gartner 2024 리포트: B2B SaaS 이탈 원인 1위는 통합 복잡성"
  "업계 3개사 CTO 인터뷰: 모두 이 문제를 최우선 과제로 언급"
...
(analogy, statistics, example, sign, principle, consequence도 위와 동일한 포맷으로 scheme 특성에 맞게 질문 생성)

추가 근거가 있으면 계속 묻는다. 인간이 "충분하다" 또는 "다음으로"라고 하면 종료.
...
❓ Warrant: 이 근거가 주장을 어떻게 지지합니까?
   "{Grounds 요약} 이기 때문에 {Claim}"의 논리적 연결

──── 예시 ────
  "전환 비용이 높을수록 기존 솔루션 유지 동기가 강해진다"  (pain-to-retention)
  "early mover는 네트워크 효과로 시장 점유율을 고착화한다"  (first-mover logic)
  "데이터가 패턴을 보여줄 때 그 패턴은 인과를 암시한다"    (data-to-causation)
...
──── 기타 ────
  [4] 직접 작성
  [5] 이건 당연하다 (Implicit) — ⚠️ /sowhat:challenge 공격에 취약
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

인간이 [5] Implicit을 선택하면: `⚠️ Implicit Warrant는 /sowhat:challenge에서 가장 먼저 공격받습니다. 계속하시겠습니까?` 확인 후 진행.
...
인간 선택 후 Qualifier 조건도 묻는다:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❓ 이 "{qualifier}"가 적용되는 조건은 무엇입니까?
   (어떤 상황에서 이 주장이 성립하는가)

──── 제안 ────
  [1] {이 논증 맥락에 맞는 조건 제안 1}
  [2] {조건 제안 2}
  [3] 별도 조건 없음
...
──── 예시 ────
  행동경제학 연구: 전환 비용은 손실 회피 편향을 강화한다
  Harvard Business Review: first-mover 우위는 B2B SaaS에서 유의미함
...
──── 제안 ────
  [1] {scheme Critical Question에서 도출한 가장 강한 반론 + 대응 제안 1}
  [2] {반론 + 대응 제안 2}
  [3] {반론 + 대응 제안 3}
...
## Warrant (논거 연결)
> {Grounds가 Claim을 지지하는 이유. "A이기 때문에 B이다"의 논리적 연결고리}
...
## [{datetime}] expand({section})
  Added: {완료된 필드 목록 (예: claim, grounds, warrant, qualifier, rebuttal)}
  Scheme: {scheme}
  Qualifier: {qualifier}
...
- **인간이 답한 것을 구조화한다** — Claude의 판단을 주입하지 않는다
...
- **scheme이 증거 요건을 결정한다** — statistics만 수치를 요구하지 않는다
